...
_LINUX_NAMESPACE_REMEDIATION = (
    ...
    "On Ubuntu 24.04+ this is usually AppArmor restricting unprivileged user\n"
    "namespaces. Either disable that restriction:\n"
    "  sudo sysctl -w kernel.apparmor_restrict_unprivileged_userns=0\n"
    "(persist via /etc/sysctl.d/) or run inside a container that allows userns:\n"
...
class LinuxClient:
    ...
    def build_argv(
        ...
        *,
        ...
        Hardening:
          - Explicit user, PID, and network namespaces. Matches Codex's bwrap
            shape; avoids asking the kernel for cgroup/IPC/UTS namespaces this
